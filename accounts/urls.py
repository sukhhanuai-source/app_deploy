...
urlpatterns = [
    ...
    path('surveyor_dash', views.surveyor_dashboard_view, name='surveyor_dash'),
    ...
    path('dashboard/admin/urls/', views.admin_urls_view, name='admin_urls'),
    ...
    path('surveyor/home/', views.surveyor_home_view, name='surveyor_home'),
    path('surveyor/urls/', views.surveyor_urls_view, name='surveyor_urls'),
